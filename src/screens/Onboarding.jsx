...
const ONBOARDING_SLIDES = [
  ...
  { ic: '💎', title: 'Зачем нужна подписка?', text: 'Пока пользователям доступен полный функционал приложения, позже на бесплатной подиске Base — будет доступно 2 встречи в месяц как гость и 2 как организатор. Pro снимает это ограничение и открывает фильтры на карте. Ultimate — самая выгодная годовая подписка, и возможность создания детальных фильтров для поиска гостей под вашу встречу.' },
  { ic: '🏆', title: 'Профиль', text: 'За встречи начисляются достижения, растёт рейтинг и явка. В профиле — вся статистика, а в настройках (🔧) — прочее управление.' },
];
...
export default function Onboarding({ onFinish }) {
  ...
  // Автоматическое пролистывание — каждый слайд держится 10 секунд, как в сторис
  useEffect(() => {
